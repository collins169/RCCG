...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>The Ambassador CMS | Departments</title>
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Departments
                                            <small>View Total Departments</small>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_3"> <i class="icon-plus font-white"></i> Click here to Add New Department </a>
                                </h4>
                            </div>
                            <div id="accordion1_3" class="panel-collapse collapse in">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form method='post' class="form-horizontal form-bordered" id='new_dept' name="new_dept">
                                        <div class="message"></div>
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Department Name</label>
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='dept_name' id="dept_name" placeholder="Enter the Department Name" required>
                                                </div>
                                            </div><br>
                                    ...
                                    <div id="departments"><img id="loader-img" alt="" src="loading.gif" width="100" height="100" align="center" style="position: absolute;left: 50%;margin-top:2px;"/></div>
            ...
            $(document).ready(function(){
                department();
                  ...
                  // },3000);
                            ...
                            $("#new_dept").submit(function(event){
