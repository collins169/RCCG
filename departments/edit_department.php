...
if (isset($_GET['edit'])) {
                        $id=$_GET['edit'];
                        $sql2=mysqli_query($connect,"SELECT * FROM departments WHERE id=$id");
                        $g=mysqli_fetch_assoc($sql2);
    }else{
                                                echo "<script>alert('Invaild Department')
                                                window.location.href='departments.php'</script>
                                                        ";
                                            }
?>
<!DOCTYPE html>
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                     ...
                                     <div class="btn-group">
                                        <a href='departments.php' id="sample_editable_1_new" class="btn sbold red"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="hidden" name="id" id='id' value="<?php echo $g['id'] ?>" >
                                                     <input type="text" class="form-control" name='dept_name' id="dept_name" value="<?php echo $g['name'] ?>" required>
                                                </div>
                                            </div><br>
