...
if (isset($_GET['view'])) {
                        ...
                        $sql=mysqli_query($connect, "SELECT *  FROM members WHERE departments_id=$id AND deleted=0")or die('unable to process request');
...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>The Ambassador CMS | Department Members</title>
                ...
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
                                        ...
                                        <div class="mt-content-body">
                                            <div class="portlet box blue">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-sitemap"></i><?php echo $g['name'] ?></div>
                                                        <div class="tools"> </div>
                                                    </div>
                     ...
                     ?>
                                                ...
                                                window.location.href='../departments/departments.php'</script>
                                                        ";
                                            } ?>
                                                    </div>
                                                </div>
