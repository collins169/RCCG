...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>The Ambassador CMS | Members</title>
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Members
                                            <small>View Total Members</small>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                                        ...
                                        <div class="mt-content-body">
                                            <div class="portlet box blue">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-users"></i>Members</div>
                                                        <div class="tools"> </div>
                                                    </div>
            ...
            ?>
                                                <tr>
                                                    ...
                                                    <td><div class="btn-group">
                                                        <button class="btn btn-xs blue dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Actions <i class="fa fa-angle-down"></i>
                                                        </button>
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                <a href="view_member.php?view=<?php echo $data['id']; ?>">
                                                                    <i class="icon-eye"></i> View </a>
                                                            </li>
                                                            <li>
                                                                <a href="edit_member.php?edit=<?php echo $data['id']; ?>">
                                                                    <i class="icon-note"></i> Edit </a>
                                                            </li>
                                                            <li>
                                                                <?php if($data['deleted']==0){ ?>
                                                                        <a href="members.php?deactivate=<?php echo $data['id']; ?>">
                                                                            <i class="icon-close"></i> Deactivate</a>
                                                                <?php }else{ ?>
                                                                        <a href="members.php?activate=<?php echo $data['id']; ?>">
