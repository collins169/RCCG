...
if(!empty($total5)){
$sql6=mysqli_query($connect, "SELECT COUNT(*) AS COUNT FROM members WHERE id!=$total5[members_id]")or die("Unable to process request COUNT");
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo date('jS M, Y',strtotime($dob)) ?>" disabled> 
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
