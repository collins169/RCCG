                            ...
                            ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" onchange="select(this)" name="occupation" id='occupation' required>
                                            <option value="">----  Select Option ----</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label" id='school2' name='school2' style="display: none;">Select School</label>
                                            <select class="form-control" name="school" id="school" required style="display: none;">
