...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>The Ambassador CMS | Search</title>
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_3"> <i class="icon-plus font-family"></i> Search Member </a>
                                </h4>
                            </div>
                            <div id="accordion1_3" class="panel-collapse collapse in">
                                    <div class="panel-body"> 
                                        ...
                                        <button type="submit" name='submit' class="btn black">
