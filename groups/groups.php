...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>The Ambassador CMS | Groups</title>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_3"> <i class="icon-plus font-white"></i> Click here to Add New Group </a>
                                </h4>
                            </div>
                            <div id="accordion1_3" class="panel-collapse collapse in">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method='post' class="form-horizontal form-bordered" id='new_group' name="new_group">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" class="form-control" name='group_name' id="group_name" placeholder="Enter the Group Name" required>
                                                </div>
                                            </div><br>
                                    ...
                                    <div id="groups"><img id="loader-img" alt="" src="loading.gif" width="100" height="100" align="center" style="position: absolute;left: 50%;margin-top:2px;"/></div>
