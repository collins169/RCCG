<?php include '../functions/db.php';
 if (isset($_GET['view'])) {
                        ...
                        $sql=mysqli_query($connect, "SELECT *  FROM members WHERE groups_id=$id AND deleted=0")or die('unable to process request');
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>groups
                                            <small>View Total Group Member</small>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                     ...
                                     <div class="btn-group">
                                        <a href='groups.php' id="sample_editable_1_new" class="btn sbold red"> 
