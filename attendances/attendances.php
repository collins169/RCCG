                                            ...
                                            <div class="portlet box blue">
                                                    ...
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                            ...
                                                            <tbody>
            <?php  $sql=mysqli_query($connect, "SELECT * FROM members WHERE deleted=0") or die("Unable to Process request member");
                     if(!empty($sql)){
                        $j=0;
                        foreach($sql as $data){
                            $j++;
                                 ...
                                 ?>
                                    ...
                                    <?php }elseif(!empty($sql)){?>
                                        ...
                                        <?php }else{echo "Marked";} ?>
                                                                     ...
                                                                     <td> 
                                <?php 
                                $sql2=mysqli_query($connect, "SELECT * FROM attendances WHERE members_id='$data[id]' AND attendance='Latter rain' AND marked=1") or die("Unable to process request");
