                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-content">
                                ...
                                <br>
                                <br>
                                    <div id="marked"><img id="loader-img" alt="" src="loading.gif" width="100" height="100" align="center" style="position: absolute;left: 50%;margin-top:2px;"/></div>
                                </div>
                            </div>
...
<![endif]-->
    ...
    //..........................................................................//
                ...
                $("#results").on( "click", ".pagination a", function (e){
                    ...
                    $("#results").load("fetch_pages.php",{"page":page,"id":id}, function(){ //get content from PHP page
        ...
        <script type = "text/javascript">
            ...
            function getdata(pageno){
                // source of data
                var targetURL = 'attendances.php?page=' + pageno;
             
                // show loading animation
                $('.marked').html('<img id="loader-img" alt="" src="loading.gif" width="100" height="100" align="center" style="position: absolute;left: 50%;margin-top:2px;"/>');
             
                // load to show new data
                $('.marked').load(targetURL).hide().fadeIn('slow');
            }
        </script>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
              $('.search').keyup(function(){
                ...
                var listItem = $('.results tbody').childern('tr');
