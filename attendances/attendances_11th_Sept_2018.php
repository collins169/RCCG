...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>The Ambassador CMS | Attendances</title>
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                     ...
                                     <div class="btn-group">
                                        <a href='attendances_record.php' id="sample_editable_1_new" class="btn sbold blue"> <i class="icon icon-eye"></i> View Records
                                        </a>
                                      </div><br><br>
                                    <!-- END PAGE BREADCRUMBS -->
                                   
                                        <div id="results"><img id="loader-img" alt="" src="loading.gif" width="100" height="100" align="center" style="position: absolute;left: 50%;margin-top:2px;"/><!-- content will be loaded here --></div>
                                </div>
                            </div>
...
<![endif]-->
        ...
        <script>
            function latterRain(id)
            {
                ...
                xmlhttp.open("GET", "latterrain.php?id=" +id, true);
                xmlhttp.send();
                document.getElementById("btn-latter"+id).innerHTML = "Marked";
                document.getElementById("btn-latter"+id).className = 'btn btn-xs red';
                document.getElementsById("btn-latter"+id).setAttribute("disable", "disable");
            }
             function earlyRain(id)
            {
                var xmlhttp = new XMLHttpRequest();
                xmlhttp.open("GET", "earlyrain.php?id=" +id, true);
                xmlhttp.send();
                document.getElementById("btn-early"+id).innerHTML = "Marked";
                document.getElementById("btn-early"+id).className = 'btn btn-xs red';
                document.getElementsById("btn-early"+id).setAttribute("disable", "disable");

            }
        </script>
        <script type="text/javascript">
            $(document).ready(function(){
                $("#results" ).load( "ajax_load.php"); //load initial records
                ...
                $("#results").on( "click", ".pagination a", function (e){
                    ...
                    $("#results").load("ajax_load.php",{"page":page,"id":id}, function(){ //get content from PHP page
                    })
