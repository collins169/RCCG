<?php include '../functions/db.php';
 if (isset($_GET['view'])) {
                        ...
                        $sql=mysqli_query($connect, "SELECT *  FROM members WHERE families_id=$id AND deleted=0")or die('unable to process request');
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                     ...
                                     <div class="btn-group">
                                        <a href='families.php' id="sample_editable_1_new" class="btn sbold red"> 
                                        ...
                                        <div class="mt-content-body">
                                            <div class="portlet box blue">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-bar-chart"></i><?php echo $g['name'] ?></div>
                                                        <div class="tools"> </div>
                                                    </div>
