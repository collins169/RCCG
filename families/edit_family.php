...
if (isset($_GET['edit'])) {
                        $id=$_GET['edit'];
                        $sql2=mysqli_query($connect,"SELECT * FROM families WHERE id=$id");
                        $g=mysqli_fetch_assoc($sql2);
    }else{
                                                echo "<script>alert('Invaild Family')
                                                window.location.href='families.php'</script>
                                                        ";
                                            }
?>
<!DOCTYPE html>
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                     ...
                                     <div class="btn-group">
                                        <a href="families.php" id="sample_editable_1_new" class="btn sbold red"> <i class="icon icon-arrow-left"></i> Back 
                                        </a>
                                      </div><br><br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="hidden" name="id" id='id' value="<?php echo $g['id'] ?>" >
                                                     <input type="text" class="form-control" name='family_name' id="family_name" value="<?php echo $g['name'] ?>" required>
                                                </div>
                                            </div><br>
