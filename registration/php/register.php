...
if($_POST['surname'] !="" || $_POST['first_name'] !="" || $_POST['email'] !=""
    ...
    $family = htmlspecialchars(strip_tags($_POST['family']));
    $martial_status = htmlspecialchars(strip_tags($_POST['martial']));
    $gender = htmlspecialchars(strip_tags($_POST['gender']));


    $CHECK_SURNAME = mysqli_query($connect, "SELECT * FROM members WHERE surname='".$surname."' AND first_name='".$firstname."' ") or die ("Failed to search surname and firstname");
    if(mysqli_num_rows($CHECK_SURNAME)>0){
        ...
        $CHECK_PHONE = mysqli_query($connect, "SELECT * FROM members WHERE phone='".$phone."' ") or die ("Failed to search phone number");
        if(mysqli_num_rows($CHECK_PHONE)>0){
            ...
            $sql = "INSERT INTO members ( surname, first_name, email, phone, occupation, dob, families_id, address, martial_status, gender) VALUES ('', '".$surname."',  '".$firstname."', '".$email."', '".$phone."', '".$occupation."', '".$dob."', '".$family."', '".$address."', '".$martial_status."', '".$gender."')";
            $INSERT = mysqli_query($connect, $sql) or die ("Failed to add member");
            if($INSERT == TRUE || $INSERT == 1){
                $rs= mysqli_query($connect, 'SELECT * FROM families WHERE id='.$family.' ');
                $family_name= mysqli_fetch_assoc($rs);
                //email subject
                $subject ='RCCG The Ambassador Membership Registration';
		...
		<table style="min-width:320px;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#eaeced">
						...
						<tr>
							<td data-bgcolor="bg-module" bgcolor="#eaeced">
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="img-flex"><img src="http://rccgambprotocolgh.com/registration/images/web_banner.jpg" style="vertical-align:top;" width="600" height="249" alt="" /></td>
									</tr>
									<tr>
														...
														<table class="center" align="right" cellpadding="0" cellspacing="0">
															<tr>
																<td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
																	<a target="_blank" style="text-decoration:none;" href="#"><img src="http://rccgambprotocolgh.com/registration/images/ico-facebook.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;" align="left" vspace="0" hspace="0" width="6" height="13" alt="fb" /></a>
																</td>
																<td width="20"></td>
																<td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
																	<a target="_blank" style="text-decoration:none;" href="#"><img src="http://rccgambprotocolgh.com/registration/images/ico-twitter.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;" align="left" vspace="0" hspace="0" width="13" height="11" alt="tw" /></a>
																</td>
															</tr>
														</table>
													</th>
			...
			<tr>
                ...
                echo json_encode(
                    array(
                        'respCode'=>1,
                        'respMsg'=>"Failed to register your details, Please Try again!"
                    )
                );
            }
        }
