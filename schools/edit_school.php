...
if (isset($_GET['edit'])) {
                        $id=$_GET['edit'];
                        $sql2=mysqli_query($connect,"SELECT * FROM schools WHERE id=$id");
                        $g=mysqli_fetch_assoc($sql2);
    }else{
                                                echo "<script>alert('Invaild School')
                                                window.location.href='schools.php'</script>
                                                        ";
                                            }
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>The Ambassador CMS | Edit School</title>
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>Schools
                                            <small>View Total Schools</small>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                            ...
                            <div class="page-content">
                                <div class="container">
                                    ...
                                    <ul class="page-breadcrumb breadcrumb">
                                     ...
                                     <div class="btn-group">
                                        <a href='schools.php' id="sample_editable_1_new" class="btn sbold red"> <i class="icon icon-arrow-left"></i> Back
                                        </a>
                                      </div><br><br>
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_3"> <i class="icon-plus font-white"></i> Click here to Edit School </a>
                                </h4>
                            </div>
                            <div id="accordion1_3" class="panel-collapse collapse in">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form method='post' class="form-horizontal form-bordered" id='new_school' name="new_school">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="hidden" name="id" id='id' value="<?php echo $g['id'] ?>" >
                                                     <input type="text" class="form-control" name='school_name' id="school_name" value="<?php echo $g['name'] ?>" required>
                                                </div>
                                            </div><br>
