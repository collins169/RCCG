...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>The Ambassador CMS | Messaging</title>
                                            ...
                                            <ul class="dropdown-menu pull-left">
                                                ...
                                                <li aria-haspopup="true" class="">
                                                    <a href="../workers/ambworkers.php" class="nav-link">
                                                        <i class="icon-briefcase"></i> Ambassador Workers</a>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle accordion-toggle-styled" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_3"> <i class="icon-plus font-family"></i> Messaging </a>
                                </h4>
                            </div>
                            <div id="accordion1_3" class="panel-collapse collapse in">
                                    <div class="panel-body"> 
                                        <button type="submit" id="sms" name='sms' class="btn sbold blue"> <i class="icon icon-screen-smartphone"></i> SMS Messaging</button> <button type='submit' name='email' id="email" class="btn sbold blue"> <i class="icon icon-envelope"></i> Email Messaging
                                        </button>  
...
<![endif]-->
        ...
        //-------------------------- Displaying The email address field --------------------------------------//
